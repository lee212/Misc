...
class DescribeInstances:
    ...
    def tail(self):
        return "<br><p>* This page is generated by the execution of admin's euca-describe-instances.<br>\
                This web-based euca-describe-instances helps to viewing information about instances in summary or in detail.\
                <br><br>Refresh your browser to get fresh information.<br>\
                To show a short summary of launched instances, we simply created a statistic table.<br>\
